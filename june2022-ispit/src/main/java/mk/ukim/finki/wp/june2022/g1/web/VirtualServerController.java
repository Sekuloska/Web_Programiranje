...
public class VirtualServerController {
    ...
    public String showList(@RequestParam(required = false) Integer activeMoreThanDays,
        ...
        model.addAttribute("owners",this.userService.listAll());
        return "list";
    }
    ...
    public String showAdd(Model model) {
        model.addAttribute("owners",this.userService.listAll());
        model.addAttribute("systems", OSType.values());
        return "form";
    }
    ...
    public String showEdit(@PathVariable Long id,Model model) {
        model.addAttribute("virtualServer",this.service.findById(id));
        model.addAttribute("owners",this.userService.listAll());
        model.addAttribute("systems", OSType.values());
        return "form";
    }
     ...
     * @return The view "list.html".
     */
    @GetMapping("/VirtualServers/{id}/terminate")
